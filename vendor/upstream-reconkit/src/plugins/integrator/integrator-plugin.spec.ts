...
describe('IntegratorPlugin', () => {
  ...
  beforeEach(() => {
    ...
    projectRoot = fs.mkdtempSync(path.join(os.tmpdir(), 'reconkit-integrator-project-'));
    ...
    moduleDir = fs.mkdtempSync(path.join(os.tmpdir(), 'reconkit-integrator-module-'));
  });
  ...
  it('generates report sections', () => {
    ...
    const sections = plugin.getReportSections({
      ...
      data: {
        ...
        branchName: 'reconkit/FUN_08000960',
        commitHash: 'abc1234',
