...
export const RECONKIT_DB_VERSION = 1;

export interface ReconstructKitDbDump {
  version: number;
...
export interface ReconstructKitDbStats {
...
export class ReconstructKitDb {
  ...
  /** @internal Use `ReconstructKitDb.fromDump()` instead. */
  constructor(
  ...
  static fromDump(data: ReconstructKitDbDump): ReconstructKitDb {
    ...
    return new ReconstructKitDb(functions, vectorIds, normalizedVectors, dimension, platform);
  }
  ...
  getStats(): ReconstructKitDbStats {
