...
import { RECONKIT_DB_VERSION, ReconstructKitDb, ReconstructKitDbDump } from '~/shared/reconkit-db/reconkit-db.js';
...
describe('createDecompilePrompt', () => {
  ...
  function createTestDb(overrides: Partial<ReconstructKitDbDump> = {}): ReconstructKitDb {
    ...
    return ReconstructKitDb.fromDump(dump);
  }
