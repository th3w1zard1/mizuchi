...
patterns = [
    ...
    ("has128_cdecl", "8b442404c1e80783e001c3", "stack-arg-bitmask-nonzero-cdecl"),
    ...
    ("has128_stdcall", "8b442404c1e80783e001c20400", "stack-arg-bitmask-nonzero-stdcall"),
    ("no128_stdcall", "31c0f6442404800f94c0c20400", "stack-arg-bitmask-zero-stdcall"),
    ("has256_stdcall", "8b442404c1e80883e001c20400", "stack-arg-bitmask-nonzero-stdcall"),
    ("no256_stdcall", "31c0f6442405010f94c0c20400", "stack-arg-bitmask-zero-stdcall"),
]

tasks = []
for index, (name, hex_bytes, rule) in enumerate(patterns):
    data = bytes.fromhex(hex_bytes)
    address = 0x409000 + index * 0x10
