...
tmp = Path(sys.argv[1])
patterns = [
    ("lt_cdecl", "31c0837c2404050f9cc0c3", "stack-arg-int-lt-imm8-cdecl"),
    ("le_cdecl", "31c0837c2404060f9cc0c3", "stack-arg-int-lt-imm8-cdecl"),
    ("gt_cdecl", "31c0837c2404060f9dc0c3", "stack-arg-int-ge-imm8-cdecl"),
    ("ge_cdecl", "31c0837c2404050f9dc0c3", "stack-arg-int-ge-imm8-cdecl"),
    ("lt_stdcall", "31c0837c2404050f9cc0c20400", "stack-arg-int-lt-imm8-stdcall"),
    ("le_stdcall", "31c0837c2404060f9cc0c20400", "stack-arg-int-lt-imm8-stdcall"),
    ("gt_stdcall", "31c0837c2404060f9dc0c20400", "stack-arg-int-ge-imm8-stdcall"),
    ("ge_stdcall", "31c0837c2404050f9dc0c20400", "stack-arg-int-ge-imm8-stdcall"),
]

tasks = []
for index, (name, hex_bytes, rule) in enumerate(patterns):
    data = bytes.fromhex(hex_bytes)
    address = 0x407000 + index * 0x10
...
jq -s -e '
  length == 8 and
  ([.[] | select((.rule | startswith("stack-arg-int-")) and (.rule | contains("-imm8-")))] | length) == 8 and
