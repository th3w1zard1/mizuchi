...
tmp = Path(sys.argv[1])
base_patterns = [
    ("u8_eq", "31c04080ff070f94c0c3", "x86-64-uint8-eq-imm8-cdecl", "unsigned int value", "(unsigned char)value == 0x07u"),
    ("u8_ne", "31c04080ff070f95c0c3", "x86-64-uint8-ne-imm8-cdecl", "unsigned int value", "(unsigned char)value != 0x07u"),
    ("i8_lt", "31c04080ff070f9cc0c3", "x86-64-int8-lt-imm8-cdecl", "int value", "(signed char)value < (7)"),
    ("i8_ge", "31c04080ff070f9dc0c3", "x86-64-int8-ge-imm8-cdecl", "int value", "(signed char)value >= (7)"),
    ("i8_eq", "31c04080ff070f94c0c3", "x86-64-uint8-eq-imm8-cdecl", "unsigned int value", "(unsigned char)value == 0x07u"),
    ("u16_eq", "31c06683ff070f94c0c3", "x86-64-uint16-eq-imm8-cdecl", "unsigned int value", "(unsigned short)value == 0x07u"),
    ("u16_ne", "31c06683ff070f95c0c3", "x86-64-uint16-ne-imm8-cdecl", "unsigned int value", "(unsigned short)value != 0x07u"),
    ("i16_lt", "31c06683ff070f9cc0c3", "x86-64-int16-lt-imm8-cdecl", "int value", "(short)value < (7)"),
    ("i16_ge", "31c06683ff070f9dc0c3", "x86-64-int16-ge-imm8-cdecl", "int value", "(short)value >= (7)"),
    ("i16_eq", "31c06683ff070f94c0c3", "x86-64-uint16-eq-imm8-cdecl", "unsigned int value", "(unsigned short)value == 0x07u"),
]
...
jq -s -e '
  ...
  ([.[] | select(.rule == "x86-64-uint8-eq-imm8-cdecl")] | length) == 4 and
  ([.[] | select(.rule == "x86-64-uint8-ne-imm8-cdecl")] | length) == 2 and
  ([.[] | select(.rule == "x86-64-int8-lt-imm8-cdecl")] | length) == 2 and
  ([.[] | select(.rule == "x86-64-int8-ge-imm8-cdecl")] | length) == 2 and
  ([.[] | select(.rule == "x86-64-uint16-eq-imm8-cdecl")] | length) == 4 and
  ([.[] | select(.rule == "x86-64-uint16-ne-imm8-cdecl")] | length) == 2 and
  ([.[] | select(.rule == "x86-64-int16-lt-imm8-cdecl")] | length) == 2 and
  ([.[] | select(.rule == "x86-64-int16-ge-imm8-cdecl")] | length) == 2
