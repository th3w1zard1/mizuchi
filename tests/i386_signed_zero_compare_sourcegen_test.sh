...
tmp = Path(sys.argv[1])
patterns = [
    ("lt_cdecl", "8b442404c1e81fc3", "stack-arg-int-lt-zero-cdecl"),
    ("ge_cdecl", "8b442404f7d0c1e81fc3", "stack-arg-int-ge-zero-cdecl"),
    ("gt_cdecl", "31c0837c2404000f9fc0c3", "stack-arg-int-gt-zero-cdecl"),
    ("le_cdecl", "31c0837c2404000f9ec0c3", "stack-arg-int-le-zero-cdecl"),
    ("lt_stdcall", "8b442404c1e81fc20400", "stack-arg-int-lt-zero-stdcall"),
    ("ge_stdcall", "8b442404f7d0c1e81fc20400", "stack-arg-int-ge-zero-stdcall"),
    ("gt_stdcall", "31c0837c2404000f9fc0c20400", "stack-arg-int-gt-zero-stdcall"),
    ("le_stdcall", "31c0837c2404000f9ec0c20400", "stack-arg-int-le-zero-stdcall"),
]

tasks = []
for index, (name, hex_bytes, rule) in enumerate(patterns):
    data = bytes.fromhex(hex_bytes)
    address = 0x405000 + index * 0x10
...
jq -s -e '
  length == 8 and
  ([.[] | select(.rule | startswith("stack-arg-int-"))] | length) == 8 and
