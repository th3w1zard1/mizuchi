...
tmp = Path(sys.argv[1])
base_patterns = [
    ("a_plus_2b", "488d0477c3", "a + 2ull * b", 1, 2, 0),
    ("a_plus_3b", "488d04764801f8c3", "a + 3ull * b", 1, 3, 0),
    ("a_plus_4b", "488d04b7c3", "a + 4ull * b", 1, 4, 0),
    ("a_plus_5b", "488d04b64801f8c3", "a + 5ull * b", 1, 5, 0),
    ("a_plus_8b", "488d04f7c3", "a + 8ull * b", 1, 8, 0),
    ("two_a_plus_b", "488d047ec3", "2ull * a + b", 2, 1, 0),
    ("a_plus_b_plus_7", "488d04374883c007c3", "a + b + 0x07ull", 1, 1, 7),
    ("a_plus_4b_plus_7", "488d04b74883c007c3", "a + 4ull * b + 0x07ull", 1, 4, 7),
]
...
for index, (name, hex_bytes, expression, coeff_a, coeff_b, immediate, target_format) in enumerate(patterns):
    ...
    assert sourcegen_candidate["generator"]["rule"] == "x86-64-two-args-affine-lea64-cdecl", sourcegen_candidate
    ...
    assert any(candidate.rule == "x86-64-two-args-affine-lea64-cdecl" for candidate in synthesis_candidates), synthesis_candidates
...
jq -s -e '
  ...
  ([.[] | select(.rule == "x86-64-two-args-affine-lea64-cdecl")] | length) == 16 and
